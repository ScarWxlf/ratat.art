...
<div class="relative h-10 w-full min-w-[200px]">
	<input
		...
		class="peer rounded-[7px] border-2 border-black border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-black focus:border-2 focus:border-stone-950 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
		{name}
		{type}
		{placeholder}
		{value}
